...
## data file.
fname = "questionnaire2-g2g-IV-1.0.txt"
...
app.addRadioButton("preferred", "visual constant + 1st attitude", row="previous", column=1)
app.addRadioButton("preferred", "visual nonlinear + 1st attitude", row="previous", column=2)
app.addRadioButton("preferred", "visual constant + 2nd attitude", column=1)
app.addRadioButton("preferred", "visual nonlinear + 2nd attitude", row="previous", column=2)
