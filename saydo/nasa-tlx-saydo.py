...
# You MUST customize the "conditions" info before using the scale.
...
## data file.
fname = "nasa-rawtlx-results-saydo.txt"
...
def on_submit():
    if not os.path.exists(fname):
        ...
        header = '# ' + 'uid ' + 'condition ' + 'block ' + 'mental ' + 'physical ' + 'temporal ' + 'performance ' + 'effort ' + 'frustration'
