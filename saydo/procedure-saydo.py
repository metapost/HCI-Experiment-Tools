...
app.addHorizontalSeparator(column=0, colspan=4)
app.addCheckBox("Block-0", column=0)
app.addNamedCheckBox(name="Trials \u00D7 2", title="trial-0", row="previous", column=1)
app.addNamedCheckBox(name="TLX", title="survey-0", row="previous", column=2)
...
app.addNamedCheckBox(name="TLX", title="survey-3", row="previous", column=2)
app.addNamedCheckBox(name="Break", title="break-3", row="previous", column=3)

app.addHorizontalSeparator(column=0, colspan=4)
app.addCheckBox("Questionnaire after completion of ALL conditions", column=0)
app.stopTab()
