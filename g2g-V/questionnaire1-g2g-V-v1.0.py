...
## data file.
fname = "questionnaire1-g2g-V-v1.0.txt"
...
left_labels = ["Very Low非常困难", "Very Low非常困难", "Very Low非常不愿意", "Very Low非常不准确", "Very Low非常慢", "非常困难", "Very Low", "Very Bad"]
right_labels = ["Very High非常容易", "Very High非常容易", "Very High非常愿意", "Very High非常准确", "Very High非常快", "非常容易", "Very High", "Very Good"]


## Labels of the Conditions to be chosen from
conditions = ["?", "cross-device", "rotate", "move", "touchscreen"]
