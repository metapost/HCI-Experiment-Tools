...
app.addRadioButton("preferred", "Large Display", row="previous", column=1)
app.addRadioButton("preferred", "Cross-Device: Smartphone with Display", row="previous", column=2)
